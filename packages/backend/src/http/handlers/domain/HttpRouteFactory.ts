...
import type {
  ...
  IHttpRoute,
  RouteType,
} from '@backend/http/domain/HttpRoute';
...
export interface CreateRouteRequest {
  ...
  /**
   * Handler type determines middleware: 'public' (none), 'api'/'app' (auth)
   * - 'public': No authentication required
   * - 'api': Cookie authentication for API endpoints
   * - 'app': Cookie authentication for server-rendered pages
   */
  routeType: RouteType;
