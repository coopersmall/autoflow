...
import { getMockedCacheAdapter } from '@backend/cache/adapters/__mocks__/CacheAdapter.mock';
import { getMockedCacheClientFactory } from '@backend/cache/clients/__mocks__/CacheClientFactory.mock';
