/**
 * Configuration options for task queue behavior.
 *
 * These settings control job retention and retry strategies.
 * Use DEFAULT_TASK_QUEUE_CONFIG for sensible defaults.
 *
...
/**
 * Default configuration values for task queues.
 *
 ...
 */
export const FAST_RETRY_QUEUE_CONFIG: TaskQueueConfig = {
  completedJobRetention: 100,
  failedJobRetention: 500,
  retry: {
    strategy: 'exponential',
