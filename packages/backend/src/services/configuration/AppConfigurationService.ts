...
export type IAppConfigurationService = ExtractMethods<AppConfigurationService>;

export function createAppConfigurationService(opts?: {
  overrides?: AppOverrides;
}): IAppConfigurationService {
  return new AppConfigurationService(opts?.overrides);
}

type AppConfigKey = keyof AppConfigurationService;
export type AppOverrides = Partial<Record<AppConfigKey, string>>;
